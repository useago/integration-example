...
<script type="importmap">
  { "imports": { "@useago/sdk": "https://esm.sh/@useago/sdk@0.3.2" } }
</script>
```
...
> The SDK ships this as a ready-made overlay: `import { initDevPanel } from "@useago/sdk/devtools"`
> then `if (DEV) initDevPanel({ store, client })`.
